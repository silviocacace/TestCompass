...
➡️ Learn more: [eMBT Approach](../eMBT/README.md)
...
- **Explicit behavioural modelling**  
  Create clear, structured models that represent system behaviour and decisions.

- **AI-assisted modelling**  
  Use AAMC to generate an initial model draft and AAMR to reflect on the model and uncover assumptions.

- **Automatic test generation**  
  Generate test scenarios based on multiple coverage strategies, from minimal sets to full path coverage.

- **Impact analysis**  
  Understand how requirement changes affect existing tests and models.

- **Open standards**  
  Import and export Mermaid diagrams for collaboration, documentation, and version control.

- **Integrations**  
  Connect with Azure DevOps, Jira, Zephyr, Xray, and other test management tools.
...
It does **not** replace the in-product Quick Start Guide or instructional videos, which provide step-by-step usage instructions.

---

If you are looking for a structured, transparent, and collaborative approach to early testing, TestCompass provides the tools and workflow to support it.
